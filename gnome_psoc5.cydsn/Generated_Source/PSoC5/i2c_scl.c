...
*
* \funcusage
*  \snippet i2c_scl_SUT.c usage_i2c_scl_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet i2c_scl_SUT.c usage_i2c_scl_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet i2c_scl_SUT.c usage_i2c_scl_Read  
*******************************************************************************/
...
* preferred i2c_scl_Read() API because the 
* i2c_scl_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet i2c_scl_SUT.c usage_i2c_scl_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: i2c_scl_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use i2c_scl_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - i2c_scl_0_INTR       (First pin in the list)
    *  - i2c_scl_1_INTR       (Second pin in the list)
    *  - ...
    *  - i2c_scl_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet i2c_scl_SUT.c usage_i2c_scl_SetInterruptMode
    *******************************************************************************/
    void i2c_scl_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & i2c_scl_0_INTR) != 0u) 
		{ 
			 i2c_scl_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet i2c_scl_SUT.c usage_i2c_scl_ClearInterrupt
    *******************************************************************************/
