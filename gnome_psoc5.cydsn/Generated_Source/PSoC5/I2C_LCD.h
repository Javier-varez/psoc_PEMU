...
#define I2C_LCD_CUSTOM_CHAR_SET            (0x00u)
...
/* Function-like macros for handling I2C MAster API names on SCB and UDB */
    ...
    #define I2C_LCD_MasterReadStatus()     I2C_I2CMasterStatus()
#else
    #define I2C_LCD_MasterWriteBuf(slaveAddress, wrData, cnt, mode)  \
                                I2C_MasterWriteBuf(slaveAddress, wrData, cnt, mode)

    #define I2C_LCD_MasterReadStatus()     I2C_MasterStatus()
...
#define I2C_LCD_DEFAULT_I2C_ADDRESS        ((uint8)((uint8)(78u) >> \
                                                                            I2C_LCD_ADDRESS_SHIFT))

/* This value should be generated by API customizer */
#define I2C_LCD_NUM_COMMANDS               (16u)
...
#if(I2C_LCD_IS_SCB_MASTER_USED)
    #define I2C_LCD_MODE_COMPLETE_XFER         (I2C_I2C_MODE_COMPLETE_XFER)
    #define I2C_LCD_WRITE_COMPLETE             (I2C_I2C_MSTAT_WR_CMPLT)
#else
    #define I2C_LCD_MODE_COMPLETE_XFER         (I2C_MODE_COMPLETE_XFER)
    #define I2C_LCD_WRITE_COMPLETE             (I2C_MSTAT_WR_CMPLT)
#endif /* I2C_LCD_IS_SCB_MASTER_USED */
